...
const Form = () => {
    ...
    const createStartup = async (e) => {
        ...
        const { Name,
            ...
            Solution,
            Ask } = credentials;
        const response = await axios.post('/create-startup',
            {
                Name,
                Description,
                Website,
                            ...
                            <form className="my-4" onSubmit={createStartup}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <select className="form-select form_input" aria-label="Default select example"
                                        ...
                                        <option value="Film">Film Industry</option>
                                        <option value="Games">Game Industry</option>
                                        <option value="Music">Music Industry</option>
                                        <option value="Publishing">Publishing</option>
                                        <option value="Finance">Fin Tech</option>
                                        <option value="Education">Edu Tech</option>
                                        <option value="Eco-Friendly">Agro Industry</option>
                                    </select>
                                </div>
                                <div className="mb-3">
